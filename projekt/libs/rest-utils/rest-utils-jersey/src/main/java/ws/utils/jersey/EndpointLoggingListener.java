...
public class EndpointLoggingListener implements ApplicationEventListener {
    ...
    public void onEvent(ApplicationEvent event) {
        if (event.getType() == ApplicationEvent.Type.INITIALIZATION_APP_FINISHED) {
            ...
            //TODO: https://jersey.java.net/documentation/latest/deployment.html#environment-table-pluggability
            //TODO: resteasy configuration
    ...
    private void populate(String basePath, boolean isLocator, Resource resource,
        ...
        for (ResourceMethod method : resource.getResourceMethods()) {
            if (method.getHttpMethod().equalsIgnoreCase("OPTIONS")) {
                continue;
            }
    ...
    private static class ResourceLogDetails {
        ...
        private static final Logger logger = Logger.getLogger(ResourceLogDetails.class.getName());
